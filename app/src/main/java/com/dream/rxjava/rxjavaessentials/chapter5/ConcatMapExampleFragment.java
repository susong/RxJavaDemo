package com.dream.rxjava.rxjavaessentials.chapter5;
 ...
 */
public class ConcatMapExampleFragment extends Fragment {
    ...
    private void loadList(List<AppInfo> appInfoList) {
        ...
        Observable<Integer> range1 = Observable.range(0, 3);
        Observable<Long> interval = Observable.interval(1, TimeUnit.SECONDS);
        Observable<Long> interval1 = Observable.interval(3, TimeUnit.SECONDS);

        Observable.just(interval, interval1)
                .concatMap(new Func1<Observable<Long>, Observable<Long>>() {
                    @Override
