...
public class MergeExampleFragment extends Fragment {
    ...
    private void loadList(List<AppInfo> appInfoList) {
        ...
        List<AppInfo> reverseAppInfoList = Lists.reverse(appInfoList);

        Observable<AppInfo> observableApps = Observable.from(appInfoList);
        Observable<AppInfo> observableReversedApps = Observable.from(reverseAppInfoList);
