...
//        loadList(appInfoList);
    ...
    private void loadList(List<AppInfo> appInfoList) {
        ...
        Observable<AppInfo> fullOfDuplicates = Observable.from(appInfoList).take(3).repeat(3);
    ...
    private void distinctUntilsChanged() {
        Integer[] list = {1, 1, 2, 2, 2, 3, 3, 1, 1, 1, 5, 5};
        Observable.from(list)
                ...
                .subscribe(new Subscriber<Integer>() {
                    ...
                    public void onNext(Integer integer) {
                        XLog.d("loadList subscribe onNext : " + integer);
                    }
                });
    }
